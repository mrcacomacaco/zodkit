...
import { SchemaDiscovery } from '../../src/core/schema-discovery';
...
describe('Performance Benchmarks', () => {
  ...
  beforeEach(() => {
    performanceMonitor = new PerformanceMonitor('.zodkit/test-metrics');
  });
  ...
  it('should handle performance monitoring static methods', async () => {
    ...
    const syncResult = PerformanceMonitor.measure('sync-test', () => {
      return 'sync-result';
    });
