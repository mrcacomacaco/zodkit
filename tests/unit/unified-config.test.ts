...
import { UnifiedConfigManager, UnifiedConfigSchema, ConfigPresets, configManager } from '../../src/core/unified-config-system';
...
describe('UnifiedConfigSystem', () => {
  ...
  describe('UnifiedConfigSchema', () => {
    ...
    it('should validate custom configuration', () => {
      ...
      const config = UnifiedConfigSchema.parse(customConfig);
    ...
    it('should handle legacy zodkit configuration', () => {
      ...
      const config = UnifiedConfigSchema.parse(legacyConfig);
    ...
    it('should reject invalid rule severities', () => {
      ...
      expect(() => UnifiedConfigSchema.parse(invalidConfig)).toThrow();
    });
  ...
  describe('UnifiedConfigManager', () => {
    describe('load()', () => {
      ...
      it('should load JSON configuration file when JS config not found', async () => {
        ...
        const freshManager = new UnifiedConfigManager();
        ...
        mockFs.existsSync.mockImplementation((filePath: any) => {
          ...
          if (pathStr.endsWith('zodkit.config.js')) return false;
          if (pathStr.endsWith('zodkit.config.json')) return true;
    ...
    describe('applyPreset()', () => {
      it('should apply development preset', async () => {
        const baseConfig = UnifiedConfigSchema.parse({});
  ...
  describe('ConfigPresets', () => {
    it('should have all required presets', () => {
      ...
      expect(ConfigPresets.strict).toBeDefined();
    });

    it('should have appropriate development preset settings', () => {
      const preset = ConfigPresets.development;
    ...
    it('should have appropriate production preset settings', () => {
      const preset = ConfigPresets.production;
  ...
  describe('Global configManager', () => {
    it('should be an instance of UnifiedConfigManager', () => {
      expect(configManager).toBeInstanceOf(UnifiedConfigManager);
    });
