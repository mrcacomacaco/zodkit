...
import { HotReloadManager, HotReloadConfig, DependencyNode } from '../../src/core/hot-reload';
...
describe('HotReloadManager', () => {
  ...
  describe('Configuration and Initialization', () => {
    ...
    it('should not start when disabled', async () => {
      ...
      const disabledHotReload = new HotReloadManager(disabledConfig, mockPerformanceMonitor, mockLogger);
  ...
  describe('Invalidation Strategies', () => {
    ...
    it('should respect max depth in invalidation', () => {
      ...
      const shallowHotReload = new HotReloadManager(shallowConfig, mockPerformanceMonitor, mockLogger);
