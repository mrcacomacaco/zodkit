...
export function addGlobalOptions(command: Command): Command {
  return command
    ...
    .option('--format <type>', 'Output format: json, console, table, html, csv, markdown', 'console')
    ...
    .option('--preset <name>', 'Use configuration preset: dev, prod, ci, fast, safe, learning, performance, enterprise')
...
export const OptionGroups = {
   ...
   */
  analysis: (command: Command) => command
   ...
   */
  generation: (command: Command) => command
   ...
   */
  transformation: (command: Command) => command
   ...
   */
  collaboration: (command: Command) => command
