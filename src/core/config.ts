...
const HotReloadConfig = z
	.object({
		enabled: z.boolean().default(false),
		patterns: z.array(z.string()).default(['**/*.ts', '**/*.js']),
		ignored: z
			.array(z.string())
			.default(['**/node_modules/**', '**/dist/**', '**/build/**', '**/*.d.ts']),
...
export const ConfigSchema = z.object({
	...
	include: z
		.array(z.string())
		.default(['./src/**/*.ts', './lib/**/*.ts', './types/**/*.ts', './**/*.{ts,tsx,js,jsx}']),
	exclude: z
		.array(z.string())
		.default([
			'**/*.test.ts',
