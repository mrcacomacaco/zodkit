...
`;
	...
	private async testPluginHooks(_pluginPath: string, result: PluginTestResult): Promise<void> {
	...
	private async testPluginCommands(_pluginPath: string, result: PluginTestResult): Promise<void> {
