...
export class PerformanceProfilerEngine extends EventEmitter {
	...
	private async generateTestData(_schema: z.ZodTypeAny): Promise<BenchmarkTestData> {
	...
	private async runValidationBenchmarks(
		schema: z.ZodTypeAny,
	...
	private async analyzePerformance(
		...
		if (results.memory.heapUsed > 50 * 1024 * 1024) {
			// 50MB
			recommendations.push({
				category: 'medium',
