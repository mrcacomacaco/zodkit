...
export class SchemaTester {
  ...
  private loadContracts(schema: z.ZodTypeAny): Array<{ name: string; data: unknown }> {
  ...
  private generateFuzzInput(schema: z.ZodTypeAny): unknown {
  ...
  private analyzeSchema(schema: z.ZodTypeAny): {
    complexity: string;
  ...
  private calculateCoverage(schema: z.ZodTypeAny): number {
